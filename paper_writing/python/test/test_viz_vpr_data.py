...
def test_evaluate_vpr_system_uses_precomputed_dmatrix_and_best_pairs(tmp_path: Path) -> None:
    ...
    for folder in (database_folder, query_folder, dmatrix_dir, singlematch_dir, seqmatch_dir, graph_dir):
        folder.mkdir()
    ...
    assert dmatrix_args[5] == output_dir / 'dmatrix_out_map_query.png'
