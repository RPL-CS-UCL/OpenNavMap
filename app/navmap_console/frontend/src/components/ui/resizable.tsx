...
// react-resizable-panels v4: Group / Panel / Separator with an `orientation` prop.
// A Separator's aria-orientation is its own direction (WAI-ARIA), i.e. the opposite of
// the group's: "horizontal" means the thin full-width bar between stacked panels.
