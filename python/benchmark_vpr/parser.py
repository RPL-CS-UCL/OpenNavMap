...
def parse_arguments():
	...
	parser.add_argument("--str_backbones", type=str, nargs="+")
	parser.add_argument("--str_descriptors_dimensions", type=str, nargs="+")
	parser.add_argument("--str_vpr_models", type=str, nargs="+")
