...
if [ -z "$1" ]; then
	...
	echo "Usage: ./run_benchmark_rpe_depth_generation.sh <DATASET_NAME> (matterport3d, hkustgz_campus, ucl_campus, mapfree) N_QUERY"
	exit 1
fi
...
export OUT_DIR="/Rocket_ssd/dataset/data_litevloc/map_free_eval/$DATASET_NAME/map_free_eval/train"
export TOP_K=3
